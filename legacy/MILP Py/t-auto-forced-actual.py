...
TARGET_GW_WC1_OPPORTUNITY = 80 # 4th gameweek we force the chip
...
if not master_results:
    ...
    # Save results
    try:
        output_csv_name = f"Squad Selection t-auto-forced-actual, W{START_GAMEWEEK}-{MAX_GAMEWEEK},SHL{SUB_HORIZON_LENGTH}.csv"
