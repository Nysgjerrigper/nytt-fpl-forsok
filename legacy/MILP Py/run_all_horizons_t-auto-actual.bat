...
for %%h in (%horizons%) do (
    ...
    python "C:\Users\peram\Documents\test\MILP Py\t-auto-actual.py" --horizon %%h --start_gw !start_gw! --max_gw !max_gw!
    ...
    REM Log to CSV
    echo %%h,!start_time!,!end_time!,N/A >> timing_results_t-auto-actual.csv
